    ...
    <div class="container wow fadeInUp">
      <div class="row">
        ...
        <div class="col-md-4 subscribe-btn-container">
          <a class="subscribe-btn" href="ticketSeating.html">Buy</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="testimonials">
    <div class="container wow fadeInUp">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="profile">
            <div class="pic"><img src="img/becky.jpg" alt=""></div>
            <h4>Rebecca Slimming</h4>
          </div>
        </div>
        <div class="col-md-9">
          <div class="quote">
            <b><img src="img/quote_sign_left.png" alt=""></b> AHHHH stop! This movie almost made me drop my croissant! It really buttered my crispy flakes.  <small><img src="img/quote_sign_right.png" alt=""></small>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-9">
          <div class="quote">
            <b><img src="img/quote_sign_left.png" alt=""></b> This movie was legitness. I mean at different points I would ask... oh my freaking gosh, she's freaking dead. Other times, I would just sit there and say wow. All I have to say to other movies, is that they need to step the freak up. <small><img src="img/quote_sign_right.png" alt=""></small>
          </div>
        </div>
        <div class="col-md-3">
          <div class="profile">
            <div class="pic"><img src="img/ridhaAli.jpeg" alt=""></div>
            <h4>Ridha Ali</h4>
          </div>
        </div>
      </div>
